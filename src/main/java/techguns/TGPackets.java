...
public class TGPackets implements ITGInitializer {
	...
	public void init(FMLInitializationEvent event) {
		...
		network.registerMessage(PacketShootAmmoNotConsumingTarget.Handler.class, PacketShootAmmoNotConsumingTarget.class, packetid++, Side.CLIENT);
		network.registerMessage(PacketPlayCriticalSoundTarget.Handler.class, PacketPlayCriticalSoundTarget.class, packetid++, Side.CLIENT);
		network.registerMessage(PacketNoThingShootTarget.Handler.class, PacketNoThingShootTarget.class, packetid++, Side.SERVER);
		network.registerMessage(PacketGunsLossDurableTarget.Handler.class, PacketGunsLossDurableTarget.class, packetid++, Side.CLIENT);

...
public class AmmoType {
	...
	public AmmoType(ItemStack[] ammo,int bulletsPerMag){
	...
	public AmmoType addVariantMultiple(String key, ItemStack[] ammo,ItemStack[] bullet) {
	...
	public ItemStack[] getAmmo(int variant) {
		ItemStack[] ammo = this.variants.get(variant).ammo;
		return ammo;
	}

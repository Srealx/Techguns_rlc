...
public class AmmoTypes implements ITGInitializer{
	...
	public static final String TYPE_PENETRATE = "penetrate";
	public static final String TYPE_STRONG = "strong";
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		STONE_BULLETS.addVariant(TYPE_PROJECTILE+"_anshan",TGItems.STONE_BULLETS_ANSHAN);
		STONE_BULLETS.addVariant(TYPE_PROJECTILE+"_shanchang",TGItems.STONE_BULLETS_SHANCHANG);
		STONE_BULLETS.addVariant(TYPE_PROJECTILE+"_huagang",TGItems.STONE_BULLETS_HUAGANG);
		STONE_BULLETS.addVariant(TYPE_PROJECTILE+"_shayan",TGItems.STONE_BULLETS_SHAYAN);
		STONE_BULLETS.addVariant(TYPE_PROJECTILE+"_heiyaoshi",TGItems.STONE_BULLETS_HEIYAOSHI);
		STONE_BULLETS.addVariant(TYPE_PROJECTILE+"_zuanshi",TGItems.STONE_BULLETS_ZUANSHI);
		...
		PISTOL_ROUNDS.addVariant(TYPE_PENETRATE, TGItems.PISTOL_ROUNDS_PENETRATE);
		PISTOL_ROUNDS.addVariant(TYPE_STRONG, TGItems.PISTOL_ROUNDS_STRONG);

		RIFLE_ROUNDS = new AmmoType(TGItems.RIFLE_ROUNDS);
		RIFLE_ROUNDS.addVariant(TYPE_INCENDIARY, TGItems.RIFLE_ROUNDS_INCENDIARY);
		RIFLE_ROUNDS.addVariant(TYPE_PENETRATE, TGItems.RIFLE_ROUNDS_PENETRATE);
		...
		SHOTGUN_ROUNDS.addVariant(TYPE_PENETRATE,TGItems.SHOTGUN_ROUNDS_PENETRATE);
		...
		SMG_MAGAZINE.addVariant(TYPE_PENETRATE, TGItems.SMG_MAGAZINE_PENETRATE, TGItems.PISTOL_ROUNDS_PENETRATE);
		...
		ASSAULT_RIFLE_MAGAZINE.addVariant(TYPE_PENETRATE, TGItems.ASSAULTRIFLE_MAGAZINE_PENETRATE, TGItems.RIFLE_ROUNDS_PENETRATE);
		...
		PISTOL_MAGAZINE.addVariant(TYPE_PENETRATE, TGItems.PISTOL_MAGAZINE_PENETRATE, TGItems.PISTOL_ROUNDS_PENETRATE);
		...
		LMG_MAGAZINE.addVariant(TYPE_PENETRATE, TGItems.LMG_MAGAZINE_PENETRATE, TGItems.RIFLE_ROUNDS_PENETRATE);
		...
		MINIGUN_AMMO_DRUM.addVariant(TYPE_PENETRATE, TGItems.MINIGUN_DRUM_PENETRATE, TGItems.RIFLE_ROUNDS_PENETRATE);

		ADVANCED_MAGAZINE = new AmmoType(TGItems.ADVANCED_MAGAZINE, TGItems.ADVANCED_MAGAZINE_EMPTY, TGItems.ADVANCED_ROUNDS, 3);
		ADVANCED_MAGAZINE.addVariant(TYPE_INCENDIARY, TGItems.ADVANCED_MAGAZINE_INCENDIARY, TGItems.ADVANCED_ROUNDS_INCENDIARY);
		...
		AS50_MAGAZINE.addVariant(TYPE_PENETRATE, TGItems.AS50_MAGAZINE_PENETRATE, TGItems.SNIPER_ROUNDS_PENETRATE);
		...
		AMMO_GAUSS_RIFLE.addVariantMultiple(TYPE_INCENDIARY,new ItemStack[]{TGItems.GAUSSRIFLE_SLUGS_INCENDIARY,TGItems.ENERGY_CELL},new ItemStack[]{TGItems.GAUSSRIFLE_SLUGS_INCENDIARY,ItemStack.EMPTY});
	}

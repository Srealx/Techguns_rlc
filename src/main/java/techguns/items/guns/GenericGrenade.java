...
public class GenericGrenade extends GenericItem implements IItemTGRenderer{
	...
	public void onPlayerStoppedUsing(ItemStack stack, World worldIn, EntityLivingBase entityLiving, int timeLeft) {
        ...
        if (!worldIn.isRemote)
        {
        	spawnGrenade(worldIn,entityLiving,f, firePos,stack);
        }
    	entityLiving.swingArm(entityLiving.getActiveHand());
	}

    
    public void spawnGrenade(World world, EntityLivingBase entityLiving,float charge, EnumBulletFirePos firePos,ItemStack stack){
    	...
    	GrenadeProjectile proj = this.projectile_factory.createProjectile(world, entityLiving, this.damage, speed, this.ticksToLive, spread,this.radius,this.radiusMin, this.damageMin, penetration, GenericGun.getDoBlockDamage(entityLiving), firePos, radiusMin, grav, charge, maxBounces,stack,bulletGenericDataBean);

...
public class TGArmorMaterial {
	...
	protected float factorHead=0.18f;
	protected float factorBoots=0.19f;
	protected float factorLegs=0.3f;
	protected float factorChest=0.43f;

...
public class TGSounds {
	...
	public static SoundEvent CRITICAL_STRIKE = createSoundEvent("guns.criticalstrike");
	public static SoundEvent AS50_FIRE_CS = createSoundEvent("guns.as50fire_cs");
	public static SoundEvent GAUSS_RIFLE_FIRE_CS = createSoundEvent("guns.gaussriflefire_cs");

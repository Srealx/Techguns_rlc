...
public class TGMachineRecipes {
	...
	public static void addRecipes(){
		...
		MetalPressRecipes.addRecipe("plateCarbon", new ItemStack(Items.BLAZE_ROD), TGItems.newStack(TGItems.MECHANICAL_PARTS_CARBON, 1), true);
		...
		MetalPressRecipes.addRecipe("ingotTungsten", TGItems.newStack(TGItems.TGX, 1), TGItems.newStack(TGItems.ADVANCED_ROUNDS, 9), true);
		...
		MetalPressRecipes.addRecipe("plateObsidianSteel","plateTitanium",TGItems.newStack(TGItems.GAUSSRIFLE_SLUGS,8), true);
		MetalPressRecipes.addRecipe(TGItems.newStack(TGItems.SNIPER_ROUNDS_INCENDIARY, 6), TGItems.newStack(TGItems.TGX, 1), TGItems.newStack(TGItems.SNIPER_ROUNDS_EXPLOSIVE, 6), true);
		// 钢制零件
		MetalPressRecipes.addRecipe("ingotSteel","gemDiamond",TGItems.newStack(TGItems.MECHANICAL_PARTS_STEEL, 1),true);
		//CHEM LAB
		...
		if (TGFluids.fuels.isEmpty() || TGConfig.keepLavaRecipesWhenFuelIsPresent){
			...
			ChemLabRecipes.addRecipe(fuelTankEmpty, 1, (ItemStack)null, 0, null, 0, new FluidStack(TGFluids.LAVA,250), null, fuelTank, false, 1);
		...
		ChemLabRecipes.addRecipe(uranium, 1, nullStack, 0, null, 0, new FluidStack(TGFluids.ACID,250), null, TGItems.newStack(TGItems.YELLOWCAKE, 4), false, 50);
		...
		// TODO
		ChemLabRecipes.addRecipe(TGBlocks.TG_ORE.getStackFor(EnumOreType.ORE_TUNGSTEN), 1, (ItemStack) null, 0, null, 0, new FluidStack(TGFluids.WATER,150), null, TGItems.newStack(TGItems.INGOT_TUNGSTEN,1), false, 30);
		// TODO
		ChemLabRecipes.addRecipe(TGItems.RIFLE_ROUNDS, 6, new ItemStack(Items.BLAZE_POWDER), 1, null, 0, new FluidStack(TGFluids.LAVA,100), null, TGItems.newStack(TGItems.RIFLE_ROUNDS_INCENDIARY,6), false, 25);
		ChemLabRecipes.addRecipe(TGItems.PISTOL_ROUNDS, 13, new ItemStack(Items.BLAZE_POWDER), 1, null, 0, new FluidStack(TGFluids.LAVA,100), null, TGItems.newStack(TGItems.PISTOL_ROUNDS_INCENDIARY,13), false, 25);
		ChemLabRecipes.addRecipe(TGItems.SNIPER_ROUNDS, 4, new ItemStack(Items.BLAZE_POWDER), 1, null, 0, new FluidStack(TGFluids.LAVA,100), null, TGItems.newStack(TGItems.SNIPER_ROUNDS_INCENDIARY,4), false, 25);
		ChemLabRecipes.addRecipe(TGItems.SHOTGUN_ROUNDS, 15, new ItemStack(Items.BLAZE_POWDER), 1, null, 0, new FluidStack(TGFluids.LAVA,100), null, TGItems.newStack(TGItems.SHOTGUN_ROUNDS_INCENDIARY,15), false, 25);

		ChemLabRecipes.addRecipe(TGItems.ADVANCED_ROUNDS, 3, new ItemStack(Items.BLAZE_POWDER), 1, null, 0, new FluidStack(TGFluids.LAVA,200), null, TGItems.newStack(TGItems.ADVANCED_ROUNDS_INCENDIARY,3), false, 40);
		ChemLabRecipes.addRecipe(TGItems.GAUSSRIFLE_SLUGS, 1, new ItemStack(Items.BLAZE_POWDER), 1, null, 0, new FluidStack(TGFluids.LAVA,250), null, TGItems.newStack(TGItems.GAUSSRIFLE_SLUGS_INCENDIARY,1), false, 40);
		// TODO
		ChemLabRecipes.addRecipe(TGItems.RIFLE_ROUNDS, 6, TGItems.INGOT_TUNGSTEN, 1, null, 0, new FluidStack(TGFluids.WATER,150), null, TGItems.newStack(TGItems.RIFLE_ROUNDS_PENETRATE,6), false, 25);
		ChemLabRecipes.addRecipe(TGItems.PISTOL_ROUNDS, 13, TGItems.INGOT_TUNGSTEN, 1, null, 0, new FluidStack(TGFluids.WATER,150), null, TGItems.newStack(TGItems.PISTOL_ROUNDS_PENETRATE,13), false, 25);
		ChemLabRecipes.addRecipe(TGItems.SHOTGUN_ROUNDS, 15, TGItems.INGOT_TUNGSTEN, 1, null, 0, new FluidStack(TGFluids.WATER,150), null, TGItems.newStack(TGItems.SHOTGUN_ROUNDS_PENETRATE,15), false, 25);
		ChemLabRecipes.addRecipe(TGItems.SNIPER_ROUNDS, 4, TGItems.INGOT_TUNGSTEN, 1, null, 0, new FluidStack(TGFluids.WATER,150), null, TGItems.newStack(TGItems.SNIPER_ROUNDS_PENETRATE,4), false, 25);
		 ...
		 * FABRICATOR
		 */
		FabricatorRecipe.addRecipe(new ItemStackOreDict("ingotGold"), 1, FabricatorRecipe.copperWires, 1, FabricatorRecipe.redstone, 2, FabricatorRecipe.plastic, 1, TGItems.ENERGY_CELL_EMPTY, 1);
		 ...
		 * CHARGING STATION
		 */
		ChargingStationRecipe.addRecipe(new ItemStackOreDict(TGItems.ENERGY_CELL_EMPTY), TGItems.ENERGY_CELL, 30000);
		ChargingStationRecipe.addRecipe(new ItemStackOreDict(TGItems.REDSTONE_BATTERY_EMPTY), TGItems.REDSTONE_BATTERY, 15000);
		...
		//Recipes
										 ...
										 */
		ReactionChamberRecipe.addRecipe("RC_UV_WHEAT",new ItemStackOreDict(new ItemStack(Items.WHEAT_SEEDS, 1)), TGItems.RC_UV_EMITTER, FluidRegistry.WATER, new ItemStack[]{new ItemStack(Items.WHEAT,1), new ItemStack(Items.WHEAT_SEEDS,2)}, 10, 5, 3, 1, 1, 1000, 0.2f, RiskType.EXPLOSION_LOW,4000);
		
		ReactionChamberRecipe.addRecipe("RC_LASER_FOCUS",new ItemStackOreDict("gemDiamond",1), TGItems.RC_HEAT_RAY, TGFluids.LIQUID_REDSTONE, new ItemStack[]{TGItems.newStack(TGItems.LASER_FOCUS, 1)}, 10, 5, 3, 1, 4, 4000, 0.5f, RiskType.BREAK_ITEM,10000);
		
		ReactionChamberRecipe.addRecipe("RC_TITANIUM",new ItemStackOreDict(new ItemStack(TGBlocks.TG_ORE, 1,EnumOreType.ORE_TITANIUM.ordinal())), TGItems.RC_HEAT_RAY, TGFluids.ACID, new ItemStack[]{TGItems.newStack(TGItems.ORE_TITANIUM, 2)}, 2, 4, 5, 0, 3, 150,0f, RiskType.BREAK_ITEM, 10000);
		
		ReactionChamberRecipe.addRecipe("RC_BLAZEROD",new ItemStackOreDict(TGItems.newStack(TGItems.QUARTZ_ROD, 1)), TGItems.RC_HEAT_RAY, TGFluids.LAVA, new ItemStack[]{new ItemStack(Items.BLAZE_ROD, 1)}, 5, 3, 7, 2, 4, 1000,0.5f, RiskType.BREAK_ITEM, 6000);
		
		ReactionChamberRecipe.addRecipe("RC_GLOWSTONE",new ItemStackOreDict("blockRedstone"), TGItems.RC_HEAT_RAY, TGFluids.LAVA, new ItemStack[]{new ItemStack(Blocks.GLOWSTONE, 1)}, 5, 3, 7, 2, 4, 1000,0.2f, RiskType.EXPLOSION_MEDIUM, 30000);
		
		ReactionChamberRecipe.addRecipe("RC_ANTIGRAV",new ItemStackOreDict(new ItemStack(Items.NETHER_STAR)), TGItems.RC_HEAT_RAY, TGFluids.LIQUID_ENDER, new ItemStack[]{TGItems.newStack(TGItems.ANTI_GRAV_CORE, 1)}, 10, 7, 8, 2, 4, 4000, 1f, RiskType.EXPLOSION_LOW, 100000);
		
		ReactionChamberRecipe.addRecipe("RC_URANIUM",new ItemStackOreDict("dustUranium"), TGItems.RC_HEAT_RAY, TGFluids.WATER, new ItemStack[]{TGItems.newStack(TGItems.ENRICHED_URANIUM, 1)}, 5, 4, 7, 0, 3, 1000, 0f, RiskType.BREAK_ITEM, 15000);
		...
		GrinderRecipes.addRecipe(TGuns.goldenrevolver,  ironAndWood(0,1,0),new ItemStack[] {new ItemStack(Items.GOLD_INGOT,3)});
		GrinderRecipes.addRecipe(TGuns.goldenrevolverBoss, ironAndWood(0,1,0) ,new ItemStack[] {new ItemStack(Items.GOLD_INGOT,5)});
		GrinderRecipes.addRecipe(TGuns.thompson, ironAndWood(4,1,0),new ItemStack[]{TGItems.newStack(TGItems.MECHANICAL_PARTS_IRON,1)});
		GrinderRecipes.addRecipe(TGuns.ak47, BARREL_OBSI, ironAndWood(0,1,0), new ItemStack[]{TGItems.newStack(TGItems.MECHANICAL_PARTS_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.boltaction, BARREL_OBSI, ironAndWood(1,1,0),new ItemStack[]{TGItems.newStack(TGItems.MECHANICAL_PARTS_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.m4, BARREL_OBSI, steelAndPlastic(1,2,0),new ItemStack[]{TGItems.newStack(TGItems.MECHANICAL_PARTS_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.m4_infiltrator, BARREL_OBSI, steelAndPlastic(2,2,0), new ItemStack[] {new ItemStack(Items.REDSTONE,1)},new ItemStack[]{TGItems.newStack(TGItems.MECHANICAL_PARTS_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.pistol, BARREL_OBSI, steelAndPlastic(0, 1, 0), new ItemStack[]{TGItems.newStack(TGItems.MECHANICAL_PARTS_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.combatshotgun, BARREL_OBSI, steelAndPlastic(1, 2, 0),new ItemStack[]{TGItems.newStack(TGItems.MECHANICAL_PARTS_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.mac10, BARREL_OBSI, steelAndPlastic(0,0,5),new ItemStack[]{TGItems.newStack(TGItems.MECHANICAL_PARTS_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.flamethrower, steelAndPlastic(0, 2, 0), ironAndWood(1, 0, 0),new ItemStack[]{TGItems.newStack(TGItems.MECHANICAL_PARTS_OBSIDIAN_STEEL,1), TGItems.newStack(TGItems.INGOT_OBSIDIAN_STEEL,2)});
		GrinderRecipes.addRecipe(TGuns.rocketlauncher, new ItemStack[] {TGItems.newStack(TGItems.INGOT_OBSIDIAN_STEEL,5)}, steelAndPlastic(1, 0, 1),new ItemStack[]{TGItems.newStack(TGItems.MECHANICAL_PARTS_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.grimreaper, new ItemStack[] {TGItems.newStack(TGItems.INGOT_OBSIDIAN_STEEL, 32), TGItems.newStack(TGItems.CIRCUIT_BOARD_ELITE, 1), TGItems.newStack(TGItems.PLATE_CARBON, 1),TGItems.newStack(TGItems.MECHANICAL_PARTS_CARBON,1)});
		GrinderRecipes.addRecipe(TGuns.grenadelauncher, BARREL_OBSI, steelAndPlastic(2, 2, 0),new ItemStack[]{TGItems.newStack(TGItems.MECHANICAL_PARTS_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.aug, BARREL_OBSI, steelAndPlastic(2, 2, 0),new ItemStack[]{TGItems.newStack(TGItems.MECHANICAL_PARTS_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.netherblaster, new ItemStack[] {TGItems.newStack(TGItems.INGOT_OBSIDIAN_STEEL, 3), TGItems.newStack(TGItems.CYBERNETIC_PARTS, 2),TGItems.newStack(TGItems.NETHER_CHARGE,1)});
		GrinderRecipes.addRecipe(TGuns.biogun, steelAndPlastic(0, 2, 0), new ItemStack[] {new ItemStack(Blocks.GLASS,1),TGItems.newStack(TGItems.INGOT_OBSIDIAN_STEEL,2),TGItems.newStack(TGItems.MECHANICAL_PARTS_OBSIDIAN_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.teslagun, new ItemStack[]{TGItems.newStack(TGItems.PLATE_CARBON,3),TGItems.newStack(TGItems.MECHANICAL_PARTS_CARBON,1),TGItems.newStack(TGItems.INGOT_STEEL,1),TGItems.newStack(TGItems.WIRE_GOLD,2)});
		GrinderRecipes.addRecipe(TGuns.lmg, new ItemStack[] {TGItems.newStack(TGItems.INGOT_OBSIDIAN_STEEL, 3), TGItems.newStack(TGItems.INGOT_STEEL, 1), TGItems.newStack(TGItems.PLASTIC_SHEET, 2),TGItems.newStack(TGItems.MECHANICAL_PARTS_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.minigun, new ItemStack[] {TGItems.newStack(TGItems.INGOT_OBSIDIAN_STEEL, 18), TGItems.newStack(TGItems.INGOT_STEEL, 2),TGItems.newStack(TGItems.PLATE_OBSIDIAN_STEEL,2) ,TGItems.newStack(TGItems.MECHANICAL_PARTS_OBSIDIAN_STEEL, 1)});
		GrinderRecipes.addRecipe(TGuns.as50, new ItemStack[] {TGItems.newStack(TGItems.INGOT_OBSIDIAN_STEEL, 8), TGItems.newStack(TGItems.PLASTIC_SHEET, 2), new ItemStack(Items.DIAMOND, 1),TGItems.newStack(TGItems.MECHANICAL_PARTS_OBSIDIAN_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.vector, obsiAndPlastic(5, 2),new ItemStack[]{TGItems.newStack(TGItems.MECHANICAL_PARTS_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.scar, obsiAndPlastic(3, 2),new ItemStack[]{TGItems.newStack(TGItems.INGOT_STEEL,2),TGItems.newStack(TGItems.MECHANICAL_PARTS_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.lasergun, obsiAndPlastic(2, 2), new ItemStack[] {new ItemStack(Items.REDSTONE,2), TGItems.newStack(GOLD_OR_ELECTRUM, 3),TGItems.newStack(TGItems.MECHANICAL_PARTS_OBSIDIAN_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.blasterrifle, carbonPlasticAndRedstone(3, 1, 2), new ItemStack[] {TGItems.newStack(GOLD_OR_ELECTRUM, 3),TGItems.newStack(TGItems.MECHANICAL_PARTS_CARBON,1)});
		GrinderRecipes.addRecipe(TGuns.scatterbeamrifle, carbonPlasticAndRedstone(3, 1, 2), new ItemStack[] {TGItems.newStack(GOLD_OR_ELECTRUM, 6),TGItems.newStack(TGItems.MECHANICAL_PARTS_CARBON,1)});
	//TODO: BlasterShotgun NoREcipe
		GrinderRecipes.addRecipe(TGuns.sonicshotgun, carbonPlasticAndRedstone(3, 0, 1), new ItemStack[] {TGItems.newStack(TGItems.PLATE_TITANIUM, 1),TGItems.newStack(TGItems.MECHANICAL_PARTS_CARBON,1)});
		GrinderRecipes.addRecipe(TGuns.pdw, carbonPlasticAndRedstone(5, 0, 0), new ItemStack[]{TGItems.newStack(TGItems.CIRCUIT_BOARD_ELITE,1),TGItems.newStack(TGItems.PLATE_TITANIUM,2),TGItems.newStack(TGItems.MECHANICAL_PARTS_TITANIUM,1)});
		GrinderRecipes.addRecipe(TGuns.pulserifle, carbonPlasticAndRedstone(5, 0, 0), new ItemStack[]{TGItems.newStack(TGItems.CIRCUIT_BOARD_ELITE,1),TGItems.newStack(TGItems.PLATE_TITANIUM,2),TGItems.newStack(TGItems.MECHANICAL_PARTS_TITANIUM,1)});
		GrinderRecipes.addRecipe(TGuns.mibgun,  new ItemStack[] {TGItems.newStack(GOLD_OR_ELECTRUM, 3), TGItems.newStack(TGItems.PLATE_TITANIUM, 1), TGItems.newStack(TGItems.CIRCUIT_BOARD_ELITE,1),TGItems.newStack(TGItems.MECHANICAL_PARTS_CARBON,1)});
		...
		GrinderRecipes.addRecipe(TGuns.nucleardeathray, new ItemStack[] {TGItems.newStack(TGItems.PLATE_CARBON, 1), TGItems.newStack(TGItems.INGOT_LEAD, 2), TGItems.newStack(TGItems.MECHANICAL_PARTS_TITANIUM,1), TGItems.newStack(TGItems.CIRCUIT_BOARD_ELITE, 1),TGItems.newStack(TGItems.PLATE_TITANIUM,3)});
		GrinderRecipes.addRecipe(TGuns.gaussrifle, new ItemStack[] {TGItems.newStack(TGItems.PLATE_CARBON, 7), TGItems.newStack(TGItems.PLATE_TITANIUM, 4), TGItems.newStack(TGItems.CIRCUIT_BOARD_ELITE, 1),TGItems.newStack(TGItems.MECHANICAL_PARTS_TITANIUM,1)});
		GrinderRecipes.addRecipe(TGuns.guidedmissilelauncher, new ItemStack[] {TGItems.newStack(TGItems.INGOT_OBSIDIAN_STEEL, 8), TGItems.newStack(TGItems.WIRE_COPPER, 2),TGItems.newStack(TGItems.MECHANICAL_PARTS_OBSIDIAN_STEEL,1)});
		GrinderRecipes.addRecipe(TGuns.miningdrill, obsiAndPlastic(6, 2));
		GrinderRecipes.addRecipe(TGuns.tfg, new ItemStack[] {TGItems.newStack(TGItems.INGOT_TITANIUM, 5), TGItems.newStack(TGItems.CIRCUIT_BOARD_ELITE,1),TGItems.newStack(TGItems.INGOT_LEAD,3),TGItems.newStack(TGItems.COIL,1) ,TGItems.newStack(TGItems.MECHANICAL_PARTS_TITANIUM, 1)});
		...
		GrinderRecipes.addRecipeChance(TGItems.PISTOL_ROUNDS, new ItemStack[] {TGItems.newStack(TGItems.NUGGET_LEAD, 1), TGItems.newStack(TGItems.NUGGET_COPPER, 1), new ItemStack(Items.GUNPOWDER)}, new double[] {0.5d,1d,1.0d/18.0d});
		...
		GrinderRecipes.addRecipeChance(TGItems.SHOTGUN_ROUNDS, new ItemStack[] {TGItems.newStack(TGItems.NUGGET_LEAD, 1), TGItems.newStack(TGItems.NUGGET_COPPER, 1), new ItemStack(Items.GUNPOWDER)}, new double[] {0.4d,0.8d,0.045d});

		GrinderRecipes.addRecipeChance(TGItems.RIFLE_ROUNDS_INCENDIARY, new ItemStack[] {TGItems.newStack(TGItems.NUGGET_LEAD, 1), TGItems.newStack(TGItems.NUGGET_COPPER, 2), new ItemStack(Items.GUNPOWDER), new ItemStack(Items.BLAZE_POWDER)}, new double[] {1d,1d,0.125d, 0.16d});
		GrinderRecipes.addRecipeChance(TGItems.PISTOL_ROUNDS_INCENDIARY, new ItemStack[] {TGItems.newStack(TGItems.NUGGET_LEAD, 1), TGItems.newStack(TGItems.NUGGET_COPPER, 1), new ItemStack(Items.GUNPOWDER), new ItemStack(Items.BLAZE_POWDER)}, new double[] {0.5d,1d,1.0d/18.0d, 1d/14d});
		GrinderRecipes.addRecipeChance(TGItems.SNIPER_ROUNDS_INCENDIARY, new ItemStack[] {TGItems.newStack(TGItems.NUGGET_LEAD, 2), TGItems.newStack(TGItems.NUGGET_COPPER, 4), new ItemStack(Items.GUNPOWDER), new ItemStack(Items.BLAZE_POWDER)}, new double[] {1d,1d,0.25d, 0.2d});
		GrinderRecipes.addRecipeChance(TGItems.SHOTGUN_ROUNDS_INCENDIARY, new ItemStack[] {TGItems.newStack(TGItems.NUGGET_LEAD, 1), TGItems.newStack(TGItems.NUGGET_COPPER, 1), new ItemStack(Items.GUNPOWDER), new ItemStack(Items.BLAZE_POWDER)}, new double[] {0.4d,0.8d,0.045d, 0.06d});

		GrinderRecipes.addRecipeChance(TGItems.RIFLE_ROUNDS_PENETRATE, new ItemStack[] {TGItems.newStack(TGItems.NUGGET_LEAD, 1), TGItems.newStack(TGItems.NUGGET_COPPER, 2), new ItemStack(Items.GUNPOWDER),  TGItems.newStack(TGItems.NUGGET_TUNGSTEN,2)}, new double[] {1d,1d,0.125d, 0.7});
		GrinderRecipes.addRecipeChance(TGItems.PISTOL_ROUNDS_PENETRATE, new ItemStack[] {TGItems.newStack(TGItems.NUGGET_LEAD, 1), TGItems.newStack(TGItems.NUGGET_COPPER, 1), new ItemStack(Items.GUNPOWDER),TGItems.newStack(TGItems.NUGGET_TUNGSTEN,1)}, new double[] {0.5d,1d,1.0d/18.0d, 0.6});
		GrinderRecipes.addRecipeChance(TGItems.SNIPER_ROUNDS_PENETRATE, new ItemStack[] {TGItems.newStack(TGItems.NUGGET_LEAD, 2), TGItems.newStack(TGItems.NUGGET_COPPER, 4), new ItemStack(Items.GUNPOWDER), TGItems.newStack(TGItems.NUGGET_TUNGSTEN,2)}, new double[] {1d,1d,0.25d, 0.9});
		GrinderRecipes.addRecipeChance(TGItems.SHOTGUN_ROUNDS_PENETRATE, new ItemStack[] {TGItems.newStack(TGItems.NUGGET_LEAD, 1), TGItems.newStack(TGItems.NUGGET_COPPER, 1), new ItemStack(Items.GUNPOWDER), TGItems.newStack(TGItems.NUGGET_TUNGSTEN,1)}, new double[] {0.4d,0.8d,0.045d, 0.55});

		GrinderRecipes.addRecipeChance(TGItems.SNIPER_ROUNDS_EXPLOSIVE, new ItemStack[] {TGItems.newStack(TGItems.NUGGET_LEAD, 2), TGItems.newStack(TGItems.NUGGET_COPPER, 4), new ItemStack(Items.GUNPOWDER), new ItemStack(Items.BLAZE_POWDER), TGItems.newStack(TGItems.TGX, 1)}, new double[] {1d,1d,0.25d, 0.25d, 0.166d});

		GrinderRecipes.addRecipeChance(TGItems.INGOT_STEEL, new ItemStack[] {TGItems.newStack(TGItems.NUGGET_STEEL, 8), TGItems.newStack(TGItems.NUGGET_TUNGSTEN,1)}, new double[] {1d, 0.16d});

		GrinderRecipes.addRecipeChance(TGItems.INGOT_LEAD, new ItemStack[] {TGItems.newStack(TGItems.NUGGET_LEAD, 8), TGItems.newStack(TGItems.NUGGET_TUNGSTEN,1)}, new double[] {1d, 0.33d});
	...
	private static ItemStack[] steelAndPlastic(int steel, int plastic, int nuggets) {
		...
		if(nuggets>0) {
			ret[i++]=TGItems.newStack(TGItems.NUGGET_STEEL, nuggets);
		}
		return ret;
	}

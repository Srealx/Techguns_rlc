...
public class ChemLabTweaker {
	...
	public static void addRecipe(String input1,int amount1,String input2,int amount2, ILiquidStack fluidIn, boolean allowSwap, IItemStack output, ILiquidStack fluidOut, int rfTick){
		CraftTweakerAPI.apply(new addInputAction(TGCraftTweakerHelper.toItemStackOreDict(input1),amount1,TGCraftTweakerHelper.toItemStackOreDict(input2),amount2,null,fluidIn,allowSwap,output, fluidOut,rfTick));
	}
	...
	@ZenMethod
	public static void addRecipe(String input1,int amount1,String input2,int amount2, IItemStack input3 ,ILiquidStack fluidIn, boolean allowSwap, IItemStack output, ILiquidStack fluidOut, int rfTick){
		CraftTweakerAPI.apply(new addInputAction(TGCraftTweakerHelper.toItemStackOreDict(input1),amount1,TGCraftTweakerHelper.toItemStackOreDict(input2),amount2,input3,fluidIn,allowSwap,output, fluidOut,rfTick));
	}

	@ZenMethod
	public static void addRecipe(IItemStack input1,int amount1,String input2,int amount2, IItemStack input3 ,ILiquidStack fluidIn, boolean allowSwap, IItemStack output, ILiquidStack fluidOut, int rfTick){
		CraftTweakerAPI.apply(new addInputAction(TGCraftTweakerHelper.toItemStackOreDict(input1),amount1,TGCraftTweakerHelper.toItemStackOreDict(input2),amount2,input3,fluidIn,allowSwap,output, fluidOut,rfTick));
	}

	@ZenMethod
	public static void addRecipe(String input1,int amount1,IItemStack input2,int amount2,IItemStack input3 , ILiquidStack fluidIn, boolean allowSwap, IItemStack output, ILiquidStack fluidOut, int rfTick){
		CraftTweakerAPI.apply(new addInputAction(TGCraftTweakerHelper.toItemStackOreDict(input1),amount1,TGCraftTweakerHelper.toItemStackOreDict(input2),amount2,input3,fluidIn,allowSwap,output, fluidOut,rfTick));
	}

	@ZenMethod
	public static void addRecipe(IItemStack input1,int amount1,IItemStack input2,int amount2,IItemStack input3 ,ILiquidStack fluidIn, boolean allowSwap, IItemStack output, ILiquidStack fluidOut, int rfTick){
		CraftTweakerAPI.apply(new addInputAction(TGCraftTweakerHelper.toItemStackOreDict(input1),amount1,TGCraftTweakerHelper.toItemStackOreDict(input2),amount2, input3 ,fluidIn,allowSwap,output, fluidOut,rfTick));
	}
	...
	private static class addInputAction implements IAction
	{
		...
		public addInputAction(ItemStackOreDict input1, int amount1, ItemStackOreDict input2, int amount2,IItemStack input3 ,ILiquidStack fluidIn, boolean swap, IItemStack output,ILiquidStack fluidOut, int power) {
			super();
			this.input1 = input1;
		...
		@Override
		public void apply() {
			added_recipe = new ChemLabRecipe(input1,amount1,input2,amount2,input3,1,fluidIn,swap,output,fluidOut,power);

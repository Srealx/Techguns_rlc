...
//			 }
	...
	public static void onLivingUpdate(LivingEvent.LivingUpdateEvent event) {
		if (event.getEntity() instanceof EntityPlayer && event.getEntity().isSprinting()){
			ZoomCacheDataBean zoomCacheDataBean = PlayerDataCache.PLAYER_ZOOM_DATA.get(event.getEntity().getUniqueID());
...
//			if (!heldItemMainhand.isEmpty() && heldItemMainhand.getItem() instanceof GenericGun) {
//				IItemRenderer rendererForItem = ItemRenderHack.getRendererForItem(heldItemMainhand.getItem());
//				if (rendererForItem!=null && rendererForItem instanceof RenderGunBase){
//					RenderGunBase renderGunBase =  (RenderGunBase)rendererForItem;
//					renderGunBase.reloadAnim.play(0.5f, Boolean.TRUE, renderGunBase.reloadParams);
//				}
//			}
		}
	}

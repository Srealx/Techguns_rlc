...
private static final ResourceLocation CHEST_LOOT = new ResourceLocation(Techguns.MODID,"chests/gasstation");
	...
	static {
		...
		blockList.add(new MBlockTGSpawner(EnumMonsterSpawnerType.HOLE,3,2,200,1).addMobType(ZombieSoldier.class, 3).addMobType(ZombieFarmer.class, 1).addMobType(ZombieMiner.class, 1));

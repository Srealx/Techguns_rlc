...
public class TGExtendedPlayer implements ITGExtendedPlayer {
	...
	public Map<ItemStack,Long> canFireNextTimeOfGun = new HashMap<>(4);
	...
	@Override
	public long getFireNextTimeOfGun(ItemStack itemStack) {
		Long nextTimeCanShoot = canFireNextTimeOfGun.get(itemStack);
		System.out.println("nextTimeCanShoot: "+nextTimeCanShoot);
		if (nextTimeCanShoot==null){
			return 0;
		}
		return nextTimeCanShoot;
	}

	@Override
	public void setFireNextTimeOfGun(ItemStack itemStack, long delay) {
		canFireNextTimeOfGun.put(itemStack,delay);
	}

	@Override
	public long gunCanShootResidualTime(World world, ItemStack itemStack){
		NBTTagCompound tagCompound = itemStack.getTagCompound();
		long gunFireCooling = tagCompound.getLong("gunFireCooling");
		return gunFireCooling-world.getWorldTime();
	}

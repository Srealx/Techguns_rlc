...
import techguns.world.NetherOreGenerator;
...
public class Techguns
{
    ...
    public static final String VERSION = "rlc_beta_1.0.0";
	...
	public TGEnchantments enchantments = new TGEnchantments();
    ...
    public void preinit(FMLPreInitializationEvent event)
    {
    	...
    	if(TGConfig.doOreGenLead||TGConfig.doOreGenTin||TGConfig.doOreGenCopper) {
    		GameRegistry.registerWorldGenerator(new OreGenerator(), 1);
    	}

		if (TGConfig.doOreGenTitanium||TGConfig.doOreGenUranium){

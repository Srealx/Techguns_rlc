...
public class BlockMilitaryCrate extends GenericBlockMetaEnum<EnumMilitaryCrateType>{
	...
	protected static final ResourceLocation loottable_other = new ResourceLocation(Techguns.MODID, "blocks/military_crate_other");
	...
	static {
		...
		LootTableList.register(loottable_other);
	}

...
public class AttackHelicopter extends GenericFlyingMob
{
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(375.0D);
        this.getEntityAttribute(SharedMonsterAttributes.FOLLOW_RANGE).setBaseValue(220.0D);
       	this.getEntityAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(36.0);
            ...
            public void updateTask()
            {
                ...
                if (entitylivingbase.getDistanceSq(this.parentEntity) < 4096.0D && this.parentEntity.canEntityBeSeen(entitylivingbase))
                {
                    ...
                    if (this.attackTimer >= 14 && (this.attackTimer <24) && (this.attackTimer % 2 == 0))
                    {
                        ...
                        GenericProjectile bullet = new GenericProjectile(this.parentEntity.world, this.parentEntity,22.0f, 1.6f, 100, 0.02f, 30, 40, 18.0f, 0.45f,false,EnumBulletFirePos.CENTER,new ItemStack(TGuns.minigun));
                        ...
                        bulletGenericDataBean.setDamageUuid(UUID.randomUUID().toString());
                	    RocketProjectile rocket = new RocketProjectile(this.parentEntity.world, this.parentEntity,100.0f, 1.6f, 100, 0.02f, 1, 3, 60.0f, 0.4f,true,this.parentEntity.rand.nextBoolean()?EnumBulletFirePos.LEFT:EnumBulletFirePos.RIGHT, 4.0f, 0.0f,new ItemStack(TGuns.rocketlauncher),bulletGenericDataBean);

...
public class TGItems implements ITGInitializer{
	...
	// 新增石头子弹
	public static ItemStack STONE_BULLETS_ANSHAN;
	public static ItemStack STONE_BULLETS_SHANCHANG;
	public static ItemStack STONE_BULLETS_HUAGANG;
	public static ItemStack STONE_BULLETS_SHAYAN;
	public static ItemStack STONE_BULLETS_HEIYAOSHI;
	public static ItemStack STONE_BULLETS_ZUANSHI;

    // 新增穿甲与燃烧弹
	public static ItemStack ADVANCED_MAGAZINE_INCENDIARY;
	public static ItemStack ADVANCED_ROUNDS_INCENDIARY;
	public static ItemStack GAUSSRIFLE_SLUGS_INCENDIARY;
	public static ItemStack SHOTGUN_ROUNDS_PENETRATE;
	public static ItemStack PISTOL_ROUNDS_PENETRATE;
	public static ItemStack RIFLE_ROUNDS_PENETRATE;
	public static ItemStack RIFLE_ROUNDS_STACK_PENETRATE;
	public static ItemStack PISTOL_MAGAZINE_PENETRATE;
	public static ItemStack MINIGUN_DRUM_PENETRATE;
	public static ItemStack SMG_MAGAZINE_PENETRATE;
	public static ItemStack ASSAULTRIFLE_MAGAZINE_PENETRATE;
	public static ItemStack LMG_MAGAZINE_PENETRATE;
	public static ItemStack SNIPER_ROUNDS_PENETRATE;
	public static ItemStack AS50_MAGAZINE_PENETRATE;
	public static ItemStack PISTOL_ROUNDS_STRONG;
	public static ItemStack INGOT_TUNGSTEN;

	// 钢制零件
	public static ItemStack MECHANICAL_PARTS_STEEL;
	// 金制枪管
	public static ItemStack GOLD_BARREL;
	// 金制零件
	public static ItemStack MECHANICAL_PARTS_GOLD;
	// 钛零件
	public static ItemStack MECHANICAL_PARTS_TITANIUM;
	// 镀钛剑刃碎片(寄生虫, 但不依赖mod)
	public static ItemStack TITANIUM_BLADE_FRAGMENT;

	// 钨粒
	public static ItemStack NUGGET_TUNGSTEN;
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		// 新增石头子弹
		STONE_BULLETS_ANSHAN = SHARED_ITEM.addsharedVariant("stonebullets_anshan",TGSlotType.AMMOSLOT);
		STONE_BULLETS_SHANCHANG = SHARED_ITEM.addsharedVariant("stonebullets_shanchang",TGSlotType.AMMOSLOT);
		STONE_BULLETS_HUAGANG = SHARED_ITEM.addsharedVariant("stonebullets_huagang",TGSlotType.AMMOSLOT);
		STONE_BULLETS_SHAYAN = SHARED_ITEM.addsharedVariant("stonebullets_shayan",TGSlotType.AMMOSLOT);
		STONE_BULLETS_HEIYAOSHI = SHARED_ITEM.addsharedVariant("stonebullets_heiyaoshi",TGSlotType.AMMOSLOT);
		STONE_BULLETS_ZUANSHI = SHARED_ITEM.addsharedVariant("stonebullets_zuanshi",TGSlotType.AMMOSLOT);

		// 新增穿甲与燃烧
		MINIGUN_DRUM_PENETRATE = SHARED_ITEM.addsharedVariant("minigundrum_penetrate", TGSlotType.AMMOSLOT);
		ADVANCED_ROUNDS_INCENDIARY = SHARED_ITEM.addsharedVariant("advancedrounds_incendiary");
		ADVANCED_MAGAZINE_INCENDIARY = SHARED_ITEM.addsharedVariant("advancedmagazine_incendiary",TGSlotType.AMMOSLOT);
		SHOTGUN_ROUNDS_PENETRATE = SHARED_ITEM.addsharedVariant("shotgunrounds_penetrate", TGSlotType.AMMOSLOT);
		PISTOL_ROUNDS_PENETRATE = SHARED_ITEM.addsharedVariant("pistolrounds_penetrate",TGSlotType.AMMOSLOT);
		RIFLE_ROUNDS_PENETRATE  = SHARED_ITEM.addsharedVariant("riflerounds_penetrate",TGSlotType.AMMOSLOT);
		RIFLE_ROUNDS_STACK_PENETRATE = SHARED_ITEM.addsharedVariant("rifleroundsstack_penetrate",TGSlotType.AMMOSLOT);
		SMG_MAGAZINE_PENETRATE = SHARED_ITEM.addsharedVariant("smgmagazine_penetrate",TGSlotType.AMMOSLOT);
		PISTOL_MAGAZINE_PENETRATE = SHARED_ITEM.addsharedVariant("pistolmagazine_penetrate",TGSlotType.AMMOSLOT);
		ASSAULTRIFLE_MAGAZINE_PENETRATE = SHARED_ITEM.addsharedVariant("assaultriflemagazine_penetrate",true, TGSlotType.AMMOSLOT);
		LMG_MAGAZINE_PENETRATE = SHARED_ITEM.addsharedVariant("lmgmagazine_penetrate",true, TGSlotType.AMMOSLOT);
		GAUSSRIFLE_SLUGS_INCENDIARY = SHARED_ITEM.addsharedVariant("gaussrifleslugs_incendiary", TGSlotType.AMMOSLOT);
		AS50_MAGAZINE_PENETRATE = SHARED_ITEM.addsharedVariant("as50magazine_penetrate", true, TGSlotType.AMMOSLOT);
		SNIPER_ROUNDS_PENETRATE = SHARED_ITEM.addsharedVariant("sniperrounds_penetrate",TGSlotType.AMMOSLOT);
		PISTOL_ROUNDS_STRONG = SHARED_ITEM.addsharedVariant("pistolrounds_strong",TGSlotType.AMMOSLOT);
		INGOT_TUNGSTEN = SHARED_ITEM.addsharedVariantOptional("ingottungsten",TGConfig.addLeadIngots);

		// 机械零件-钢
		MECHANICAL_PARTS_STEEL = SHARED_ITEM.addsharedVariant("mechanicalpartssteel");
		// 黄金枪管
		GOLD_BARREL = SHARED_ITEM.addsharedVariant("goldbarrel");
		// 黄金零件
		MECHANICAL_PARTS_GOLD = SHARED_ITEM.addsharedVariant("mechanicalpartsgold");
		// 钛零件
		MECHANICAL_PARTS_TITANIUM = SHARED_ITEM.addsharedVariant("mechanicalpartstitanium");
		// 钛质剑刃碎片
		TITANIUM_BLADE_FRAGMENT = SHARED_ITEM.addsharedVariant("titaniumbladefragment");
		// 钨粒
		NUGGET_TUNGSTEN = SHARED_ITEM.addsharedVariant("nuggettungsten");
	...
	public void init(FMLInitializationEvent event) {
		...
		setAmmoTypeEntryForMagazine(ADVANCED_MAGAZINE_INCENDIARY, AmmoTypes.ADVANCED_MAGAZINE, AmmoTypes.TYPE_INCENDIARY);

		//penetrate
		setAmmoTypeEntryForMagazine(PISTOL_MAGAZINE_PENETRATE, AmmoTypes.PISTOL_MAGAZINE, AmmoTypes.TYPE_PENETRATE);
		setAmmoTypeEntryForMagazine(ASSAULTRIFLE_MAGAZINE_PENETRATE, AmmoTypes.ASSAULT_RIFLE_MAGAZINE, AmmoTypes.TYPE_PENETRATE);
		setAmmoTypeEntryForMagazine(AS50_MAGAZINE_PENETRATE, AmmoTypes.AS50_MAGAZINE, AmmoTypes.TYPE_PENETRATE);
		setAmmoTypeEntryForMagazine(SMG_MAGAZINE_PENETRATE, AmmoTypes.SMG_MAGAZINE, AmmoTypes.TYPE_PENETRATE);
		setAmmoTypeEntryForMagazine(MINIGUN_DRUM_PENETRATE, AmmoTypes.MINIGUN_AMMO_DRUM, AmmoTypes.TYPE_PENETRATE);
		setAmmoTypeEntryForMagazine(LMG_MAGAZINE_PENETRATE, AmmoTypes.LMG_MAGAZINE, AmmoTypes.TYPE_PENETRATE);
		...
		// stone
		setAmmoTypeEntryForMagazine(STONE_BULLETS, AmmoTypes.STONE_BULLETS, AmmoTypes.TYPE_DEFAULT);
	...
	public static void registerItemsToOreDict() {
		 ...
		 OreDictionary.registerOre("ingotTungsten", INGOT_TUNGSTEN);
		 ...
		 OreDictionary.registerOre("ingotTungsten", INGOT_TUNGSTEN);
		 OreDictionary.registerOre("nuggetTungsten", NUGGET_TUNGSTEN);
	}

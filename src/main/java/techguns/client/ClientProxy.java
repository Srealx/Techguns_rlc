	...
	*/
	...
	public void registerItemRenderers() {
		...
		*/
		...
		sharedRenderer.addRenderForType("assaultriflemagazine_penetrate", new RenderItemBase(new ModelARMagazine(false), new ResourceLocation(Techguns.MODID,"textures/guns/ar_mag_pen.png")).setBaseScale(1.25f).setGUIScale(0.85f).setBaseTranslation(0, -0.2f, 0).setTransformTranslations(m4magTranslations));
		...
		sharedRenderer.addRenderForType("lmgmagazine_penetrate", new RenderItemLMGMag(new ModelLmgMag(false), new ResourceLocation(Techguns.MODID,"textures/guns/lmg_mag_pen.png")).setBaseScale(1.25f).setGUIScale(0.75f).setBaseTranslation(0, 0f, 0.2f).setTransformTranslations(lmgmagTranslations));
		...
		sharedRenderer.addRenderForType("as50magazine_penetrate", new RenderItemBase(new ModelAS50Mag(false), new ResourceLocation(Techguns.MODID,"textures/guns/as50_mag_pen.png")).setBaseScale(1.5f).setGUIScale(0.75f).setBaseTranslation(0.0325f, -0.2f, 0.33f).setTransformTranslations(as50magTranslations));
		...
		ItemRenderHack.registerItemRenderer(TGuns.goldenrevolverBoss,new RenderGunBase90(new ModelGoldenRevolver(),1).setBaseTranslation(-0.35f, -0.2f, RenderItemBase.SCALE*0.5f-0.1f)
				.setBaseScale(0.75f).setGUIScale(0.75f).setMuzzleFx(ScreenEffect.muzzleFlash_gun, 0, 0.25f, -0.41f, 0.5f,0).setTransformTranslations(new float[][]{
						{0f,0.14f,0.01f}, //First Person
						{0f,0.0f,0.0f}, //Third Person
						{0.05f,0.01f,0f}, //GUI
	...
	protected void registerEntityRenderers() {
		...
		RenderingRegistry.registerEntityRenderingHandler(GenericProjectilePenetrate.class, RenderGenericProjectile<GenericProjectile>::new);
		RenderingRegistry.registerEntityRenderingHandler(GenericProjectileStrong.class, RenderGenericProjectile<GenericProjectile>::new);
		...
		RenderingRegistry.registerEntityRenderingHandler(StoneBulletProjectileAnShan.class, RenderStoneBulletAnshanProjectile::new);
		RenderingRegistry.registerEntityRenderingHandler(StoneBulletProjectileShanChang.class, RenderStoneBulletShanchangProjectile::new);
		RenderingRegistry.registerEntityRenderingHandler(StoneBulletProjectileHuaGang.class, RenderStoneBulletHuagangProjectile::new);
		RenderingRegistry.registerEntityRenderingHandler(StoneBulletProjectileShaYan.class, RenderStoneBulletShayanProjectile::new);
		RenderingRegistry.registerEntityRenderingHandler(StoneBulletProjectileHeiYaoShi.class, RenderStoneBulletHeiyaoshiProjectile::new);
		RenderingRegistry.registerEntityRenderingHandler(StoneBulletProjectileZuanShi.class, RenderStoneBulletZuanshiProjectile::new);
		...
		RenderingRegistry.registerEntityRenderingHandler(GaussProjectileIncendiary.class, RenderAdvancedBulletProjectile::new);
		RenderingRegistry.registerEntityRenderingHandler(AdvancedBulletProjectile.class, RenderAdvancedBulletProjectile::new);
		RenderingRegistry.registerEntityRenderingHandler(AdvancedBulletProjectileIncendiary.class, RenderAdvancedBulletProjectile::new);

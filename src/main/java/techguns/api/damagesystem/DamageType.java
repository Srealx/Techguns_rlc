...
public enum DamageType {
	...
	public String toString() {
		switch(this){
			...
			case PENETRATE:
				return ChatFormatting.DARK_PURPLE+I18n.format("techguns.TGDamageType.PENETRATE",new Object[0]);
			case STRONG:
				return ChatFormatting.WHITE+I18n.format("techguns.TGDamageType.STRONG",new Object[0]);
			case PIERCE:
				return ChatFormatting.BLUE+I18n.format("techguns.TGDamageType.PIERCE",new Object[0]);
			case ENERGY:
				return ChatFormatting.DARK_AQUA+I18n.format("techguns.TGDamageType.ENERGY",new Object[0]);
			case POISON:
				return ChatFormatting.DARK_GREEN+I18n.format("techguns.TGDamageType.POISONModify",new Object[0]);
			case UNRESISTABLE:
			...
			case LIGHTNING:
				return ChatFormatting.YELLOW+I18n.format("techguns.TGDamageType.LIGHTNINGS",new Object[0]);
			case RADIATION:

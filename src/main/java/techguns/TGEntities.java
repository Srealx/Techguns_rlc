...
public class TGEntities implements ITGInitializer {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		EntityRegistry.registerModEntity(new ResourceLocation(Techguns.MODID,"GenericProjectilePenetrate"), GenericProjectilePenetrate.class, "GenericProjectilePenetrate", ++Techguns.modEntityID, Techguns.MODID, bulletTrackRange, 1, true);
		EntityRegistry.registerModEntity(new ResourceLocation(Techguns.MODID,"GenericProjectileStrong"), GenericProjectileStrong.class, "GenericProjectileStrong", ++Techguns.modEntityID, Techguns.MODID, bulletTrackRange, 1, true);
		...
		EntityRegistry.registerModEntity(new ResourceLocation(Techguns.MODID,"StoneBulletProjectileAnShan"),StoneBulletProjectileAnShan.class, "StoneBulletProjectileAnShan", ++Techguns.modEntityID, Techguns.MODID, bulletTrackRange, 1, true);
		EntityRegistry.registerModEntity(new ResourceLocation(Techguns.MODID,"StoneBulletProjectileShanChang"),StoneBulletProjectileShanChang.class, "StoneBulletProjectileShanChang", ++Techguns.modEntityID, Techguns.MODID, bulletTrackRange, 1, true);
		EntityRegistry.registerModEntity(new ResourceLocation(Techguns.MODID,"StoneBulletProjectileHuaGang"),StoneBulletProjectileHuaGang.class, "StoneBulletProjectileHuaGang", ++Techguns.modEntityID, Techguns.MODID, bulletTrackRange, 1, true);
		EntityRegistry.registerModEntity(new ResourceLocation(Techguns.MODID,"StoneBulletProjectileShaYan"),StoneBulletProjectileShaYan.class, "StoneBulletProjectileShaYan", ++Techguns.modEntityID, Techguns.MODID, bulletTrackRange, 1, true);
		EntityRegistry.registerModEntity(new ResourceLocation(Techguns.MODID,"StoneBulletProjectileHeiYaoShi"),StoneBulletProjectileHeiYaoShi.class, "StoneBulletProjectileHeiYaoShi", ++Techguns.modEntityID, Techguns.MODID, bulletTrackRange, 1, true);
		EntityRegistry.registerModEntity(new ResourceLocation(Techguns.MODID,"StoneBulletProjectileZuanShi"),StoneBulletProjectileZuanShi.class, "StoneBulletProjectileZuanShi", ++Techguns.modEntityID, Techguns.MODID, bulletTrackRange, 1, true);
		...
		EntityRegistry.registerModEntity(new ResourceLocation(Techguns.MODID,"GaussProjectileIncendiary"),GaussProjectileIncendiary.class, "GaussProjectileIncendiary", ++Techguns.modEntityID, Techguns.MODID, bulletTrackRange, 1, true);
		...
		EntityRegistry.registerModEntity(new ResourceLocation(Techguns.MODID,"AdvancedBulletProjectileIncendiary"),AdvancedBulletProjectileIncendiary.class, "AdvancedBulletProjectileIncendiary", ++Techguns.modEntityID, Techguns.MODID, bulletTrackRange, 1, true);

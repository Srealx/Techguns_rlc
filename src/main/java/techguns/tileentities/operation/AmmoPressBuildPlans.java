...
public class AmmoPressBuildPlans {
	public static final int AMMOUNT_PISTOL = 18;
	public static final int AMMOUNT_PISTOL_STRONG = 9;
	public static final int AMMOUNT_SHOTGUN = 22;
	...
	public static int getAmountForRecipe(int itemdmg) {
		...
		}else if (itemdmg == TGItems.PISTOL_ROUNDS_STRONG.getItemDamage()){
			return AMMOUNT_PISTOL_STRONG;
		}
		return 1;
	}
	...
	public static ItemStack[] getPossibleResults() {
		...
		,TGItems.newStack(TGItems.PISTOL_ROUNDS_STRONG, AMMOUNT_PISTOL_STRONG)};
	}
	...
	public static ItemStack getOutputFor(ItemStack metal1, ItemStack metal2, ItemStack powder, int plan) {
		if (isValidFor(metal1, 0) && isValidFor(metal2, 1) && isValidFor(powder, 2)) {
			...
			if (metal1.getCount() >= 1 && metal2.getCount() >= 2 && powder.getCount() >= 1) {
				...
				case 4:
					return new ItemStack(TGItems.PISTOL_ROUNDS_STRONG.getItem(), AMMOUNT_PISTOL_STRONG, TGItems.PISTOL_ROUNDS_STRONG.getItemDamage());
				}
			}
		} else {
	...
	public static class AmmoPressMachineRecipe implements IMachineRecipe{
		...
		public List<List<ItemStack>> getItemOutputs() {
			...
			case 3:
				...
				break;
			case 4:
				stack = new ItemStack(TGItems.PISTOL_ROUNDS_STRONG.getItem(), AMMOUNT_PISTOL_STRONG, TGItems.PISTOL_ROUNDS_STRONG.getItemDamage());
				break;
			}
			output.add(stack);
			outputs.add(output);

	...
	public void hitBlob(int power, EntityLivingBase attacker){
		if (!this.world.isRemote) {
			...
			if(size>3){
				...
				TGExplosion explosion = new TGExplosion(world, attacker, null, this.pos.getX()+0.5, this.pos.getY()+0.5, this.pos.getZ()+0.5, 30, 15, radius, radius*1.5f,0.0f,null,0,null);

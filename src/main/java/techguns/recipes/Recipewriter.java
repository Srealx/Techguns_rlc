...
public class Recipewriter {
	...
	public static void registerItemRecipes(){
        ...
        RecipeJsonConverter.addShapelessRecipe(newStack(SMG_MAGAZINE, 1), SMG_MAGAZINE_EMPTY, PISTOL_ROUNDS, PISTOL_ROUNDS,PISTOL_ROUNDS,PISTOL_ROUNDS);
        ...
        RecipeJsonConverter.addShapelessRecipe(newStack(SMG_MAGAZINE_INCENDIARY, 1), SMG_MAGAZINE_EMPTY, PISTOL_ROUNDS_INCENDIARY, PISTOL_ROUNDS_INCENDIARY,PISTOL_ROUNDS_INCENDIARY,PISTOL_ROUNDS_INCENDIARY);
        ...
        // 穿甲弹与弹匣配方
        // 石头子弹
//        Item andesiteBlock = Item.getItemFromBlock(Blocks.STONE.getStateFromMeta(5).getBlock());
//        Item dioriteBlock = Item.getItemFromBlock(Blocks.STONE.getStateFromMeta(3).getBlock());
//        Item graniteBlock = Item.getItemFromBlock(Blocks.STONE.getStateFromMeta(1).getBlock());
        Item sandBlock = Item.getItemFromBlock(Blocks.SANDSTONE);
//        RecipeJsonConverter.addShapedRecipe(newStack(STONE_BULLETS_ANSHAN,16), andesiteBlock,andesiteBlock,andesiteBlock,Items.GUNPOWDER);
//        RecipeJsonConverter.addShapedRecipe(newStack(STONE_BULLETS_SHANCHANG,16),dioriteBlock,dioriteBlock,dioriteBlock,Items.GUNPOWDER);
//        RecipeJsonConverter.addShapedRecipe(newStack(STONE_BULLETS_HUAGANG,16),graniteBlock,graniteBlock,graniteBlock,Items.GUNPOWDER);
        RecipeJsonConverter.addShapedRecipe(newStack(STONE_BULLETS_SHAYAN,16),sandBlock,sandBlock,sandBlock,Items.GUNPOWDER);
        RecipeJsonConverter.addShapedRecipe(newStack(STONE_BULLETS_SHAYAN,10),Item.getItemFromBlock(Blocks.OBSIDIAN),Items.GUNPOWDER);
        RecipeJsonConverter.addShapedRecipe(newStack(STONE_BULLETS_ZUANSHI,16),Items.DIAMOND,Items.GUNPOWDER);

        // 子弹堆
        RecipeJsonConverter.addShapelessRecipe(newStack(RIFLE_ROUNDS_PENETRATE,4), RIFLE_ROUNDS_STACK_PENETRATE);
        RecipeJsonConverter.addShapelessRecipe(newStack(RIFLE_ROUNDS_STACK_PENETRATE,4), RIFLE_ROUNDS_PENETRATE,RIFLE_ROUNDS_PENETRATE,RIFLE_ROUNDS_PENETRATE,RIFLE_ROUNDS_PENETRATE);
        // 弹匣
        RecipeJsonConverter.addShapelessRecipe(newStack(PISTOL_MAGAZINE_PENETRATE, 1), PISTOL_MAGAZINE_EMPTY, PISTOL_ROUNDS_PENETRATE,PISTOL_ROUNDS_PENETRATE,PISTOL_ROUNDS_PENETRATE);
        RecipeJsonConverter.addShapelessRecipe(newStack(SMG_MAGAZINE_PENETRATE, 1), SMG_MAGAZINE_EMPTY, PISTOL_ROUNDS_PENETRATE,PISTOL_ROUNDS_PENETRATE,PISTOL_ROUNDS_PENETRATE,PISTOL_ROUNDS_PENETRATE);
        RecipeJsonConverter.addShapelessRecipe(newStack(ASSAULTRIFLE_MAGAZINE_PENETRATE, 1), ASSAULTRIFLE_MAGAZINE_EMPTY, RIFLE_ROUNDS_PENETRATE,RIFLE_ROUNDS_PENETRATE,RIFLE_ROUNDS_PENETRATE);
        RecipeJsonConverter.addShapelessRecipe(newStack(LMG_MAGAZINE_PENETRATE, 1), LMG_MAGAZINE_EMPTY, RIFLE_ROUNDS_PENETRATE,RIFLE_ROUNDS_PENETRATE,RIFLE_ROUNDS_PENETRATE,RIFLE_ROUNDS_PENETRATE,RIFLE_ROUNDS_PENETRATE,RIFLE_ROUNDS_PENETRATE,RIFLE_ROUNDS_PENETRATE,RIFLE_ROUNDS_PENETRATE);
        RecipeJsonConverter.addShapelessRecipe(newStack(LMG_MAGAZINE_PENETRATE,1), LMG_MAGAZINE_EMPTY, RIFLE_ROUNDS_STACK_PENETRATE, RIFLE_ROUNDS_STACK_PENETRATE);
        RecipeJsonConverter.addShapelessRecipe(newStack(MINIGUN_DRUM_PENETRATE,1), MINIGUN_DRUM_EMPTY, RIFLE_ROUNDS_STACK_PENETRATE, RIFLE_ROUNDS_STACK_PENETRATE,RIFLE_ROUNDS_STACK_PENETRATE,RIFLE_ROUNDS_STACK_PENETRATE);
        RecipeJsonConverter.addShapelessRecipe(newStack(AS50_MAGAZINE_PENETRATE,1), AS50_MAGAZINE_EMPTY, SNIPER_ROUNDS_PENETRATE, SNIPER_ROUNDS_PENETRATE);
